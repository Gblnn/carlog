                ...
                <div style={{display:"flex", gap:"1rem", alignItems:"center"}}>
                    {
                        ...
                        <CheckSquare2 width={"1.5rem"} height={"1.5rem"} className="check-square" fill={selected||props.selected?"dodgerblue":"rgba(100 100 100/ 50%)"} stroke={selected||props.selected?"white":"none"}/>
                        {
                            selected?
